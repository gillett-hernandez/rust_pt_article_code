...
use super::Material;
use crate::math::{spectral::SpectralPowerDistributionFunction, Curve, Sample2D, Vec3};
...
impl GGX {
    pub fn new(roughness: f32, eta: Curve, eta_o: Curve, kappa: Curve, permeability: f32) -> Self {
